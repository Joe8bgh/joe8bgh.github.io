function handleFormSubmit(event) {
  ...
  var myJSONString = JSON.stringify(project_json);
  myJSONString = myJSONString.toString();
  myJSONString = myJSONString.replace(/{|}/g, '');
  myJSONString = myJSONString.replace(/"/g, '');
  myJSONString = myJSONString.replace(/\\/g, '');
  myJSONString = myJSONString.replace(/n  /g, '');
  ...
  inner2.appendChild(btn).onclick = function() {
    addResults();
  }

  const btn2 = document.createElement("button");
  btn2.setAttribute('type', 'button');
  btn2.innerHTML = "Edit Project";
  inner2.appendChild(btn2).onclick = function() {
    addResults2();
  }
  ...
  const textNode = document.createTextNode("Review Project");
  para.appendChild(textNode);
  inner2.appendChild(para);
  inner2.appendChild(document.createElement("hr"));

  const para2 = document.createElement("p");
  const textNode2 = document.createTextNode("");
  para2.appendChild(textNode2);
  inner3.appendChild(para2);
  inner3.appendChild(document.createElement("hr"));
...
function addFields() {
  ...
  container.appendChild(btn).onclick = function() {
    removeFields();
  }
...
function addFields2() {
  ...
  btn.setAttribute('type', 'button');
  btn.innerHTML = "Delete";
  container2.appendChild(btn).onclick = function() {
    removeFields2();
  }
